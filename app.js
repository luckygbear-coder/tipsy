...
const DRINKS = [
  // ===================== 😮‍💨 放鬆 20 杯 =====================
  {id:1,  cat:"beer",    emoji:"🍺", name:"拉格（Lager）", tag:"清爽・順口・日常小確幸", moods:["放鬆"],
    story:"拉格像把一天的汗與煩躁洗掉：乾淨、清爽、很可靠。",
    flavor:"清爽麥香＋淡淡啤酒花，收口乾淨。",
    warn:"別空腹；容易脹氣者配點食物更舒服。",
    followUps:["你現在最想把哪件事洗掉？","今天你撐得最累的是哪裡？"]},
  {id:2,  cat:"beer",    emoji:"🍺", name:"皮爾森（Pilsner）", tag:"乾爽・俐落・讓腦袋變安靜", moods:["放鬆"],
    story:"像把『今天』切成俐落的一刀：清、脆、乾爽，思緒會更乾淨。",
    flavor:"啤酒花更明顯，苦韻俐落、清爽。",
    warn:"酸苦感可能刺激胃，請搭配食物。",
    followUps:["你想先休息，還是先放下？","你願意先對自己溫柔 1% 嗎？"]},
  {id:3,  cat:"beer",    emoji:"🍺", name:"小麥啤酒（Wheat）", tag:"柔和果香・像雲", moods:["放鬆"],
    story:"像一團雲把你包住：不刺、不硬，緊繃會鬆一點。",
    flavor:"柔和麥香，可能帶輕果香（依風格）。",
    warn:"對麩質敏感者避免；甜感也容易喝多。",
    followUps:["你想對自己溫柔一點的是哪裡？","今晚你想慢下來嗎？"]},
  {id:4,  cat:"beer",    emoji:"🍺", name:"黑啤（Stout）", tag:"可可烘焙・夜晚擁抱", moods:["放鬆"],
    story:"厚厚的黑啤像夜晚的抱抱：慢慢喝，心也慢慢安。",
    flavor:"可可/咖啡烘焙香，尾韻厚實。",
    warn:"口感濃別猛灌；配甜點/鹹食都很棒。",
    followUps:["今晚你更需要安慰，還是肯定？","你願意允許自己慢下來嗎？"]},
  {id:5,  cat:"beer",    emoji:"🍺", name:"科隆啤酒（Kölsch）", tag:"清爽淡雅・像晚風", moods:["放鬆"],
    story:"像傍晚的微風，不大，但剛好吹散一點悶。",
    flavor:"淡淡麥香，收口乾淨。",
    warn:"順口也要慢慢喝。",
    followUps:["你想把悶悶的心放哪裡？","今晚你想安靜一點嗎？"]},
  {id:6,  cat:"beer",    emoji:"🍺", name:"白啤（Witbier）", tag:"柑橘香・輕柔舒服", moods:["放鬆"],
    story:"它不逼你振作，只給你一點亮亮的呼吸。",
    flavor:"柑橘與香料的清新感。",
    warn:"冰太冷會壓香氣。",
    followUps:["你想被怎麼安慰？","你想先做哪件小事照顧自己？"]},
  {id:7,  cat:"white",   emoji:"🥂", name:"夏多內（Chardonnay）", tag:"柔光質地・舒服不刺眼", moods:["放鬆"],
    story:"像把日子調成柔光：舒服不刺眼，讓你願意對自己更好。",
    flavor:"蘋果/柑橘；部分帶奶油或烤麵包感。",
    warn:"別冰過頭；太冰會壓掉香氣。",
    followUps:["你想怎麼犒賞自己？","你今天值得被好好對待的理由是？"]},
  {id:8,  cat:"white",   emoji:"🥂", name:"白蘇維濃（Sauvignon Blanc）", tag:"清新草本・像清晨", moods:["放鬆"],
    story:"像早晨開窗那口風：清爽、明亮，讓你想重新開始。",
    flavor:"草本＋柑橘，酸度明亮。",
    warn:"胃酸敏感者配食物；慢喝。",
    followUps:["你想重新開始的第一步是？","你最想清爽掉的是什麼？"]},
  {id:9,  cat:"white",   emoji:"🥂", name:"麗絲玲（Riesling）", tag:"花果香・甜酸平衡", moods:["放鬆"],
    story:"像一句輕輕的『沒事的』，讓你不用硬撐。",
    flavor:"花香＋果香，甜酸平衡。",
    warn:"甜口容易喝快，慢慢來。",
    followUps:["你想把今天變柔軟一點嗎？","你最想被安慰的是哪一句？"]},
  {id:10, cat:"white",   emoji:"🍇", name:"慕斯卡托（Moscato）", tag:"甜甜可愛・放鬆不費力", moods:["放鬆"],
    story:"不需要很厲害才值得放鬆，你現在就可以。",
    flavor:"葡萄/花香，甜口輕盈。",
    warn:"甜口更容易不知不覺喝多。",
    followUps:["你願意對自己甜一點嗎？","你想放過自己哪件事？"]},
  {id:11, cat:"red",     emoji:"🍷", name:"梅洛（Merlot）", tag:"柔順圓潤・溫柔紅酒", moods:["放鬆"],
    story:"它不逼你勇敢，只輕輕說：你已經做得很好了。",
    flavor:"紅莓/李子香氣，口感柔順。",
    warn:"甜柔容易喝多；慢慢來。",
    followUps:["你希望有人對你說『你很好』嗎？","你最想被稱讚的一件事是？"]},
  {id:12, cat:"spirit",  emoji:"🍶", name:"清酒（純米）", tag:"米香柔和・安靜陪伴", moods:["放鬆"],
    story:"像靜靜點燈：不吵，但讓你覺得有人在。",
    flavor:"米香＋柔和甜旨，尾韻乾淨。",
    warn:"別猛灌；溫飲/冷飲皆可。",
    followUps:["你想要安靜，還是被理解？","今晚你想把心放在哪？"]},
  {id:13, cat:"spirit",  emoji:"🥃", name:"波本（Bourbon）", tag:"香草焦糖・像壁爐", moods:["放鬆"],
    story:"像冬夜的毯子：甜甜的，但不膩，讓你想照顧自己。",
    flavor:"香草＋焦糖＋烤橡木。",
    warn:"甜感會讓人低估酒精，小心。",
    followUps:["你今天最想被照顧的是心還是身體？","你願意對自己溫暖一下嗎？"]},
  {id:14, cat:"spirit",  emoji:"🥃", name:"愛爾蘭威士忌", tag:"柔順乾淨・放鬆不刺激", moods:["放鬆"],
    story:"像一句很平靜的『我在』，不吵但可靠。",
    flavor:"蜂蜜/穀物香，酒感柔順。",
    warn:"仍是烈酒，小口慢慢喝。",
    followUps:["你想先把哪個壓力放桌上？","今晚你願意只做一件事：休息嗎？"]},
  {id:15, cat:"spirit",  emoji:"🍶", name:"燒酎（Shochu）", tag:"清爽俐落・很適合慢慢喝", moods:["放鬆"],
    story:"它不搶戲，只陪你把節奏放慢。",
    flavor:"穀物/地瓜香（依種類），乾淨。",
    warn:"濃度不低，別連續杯。",
    followUps:["你想把生活調慢到什麼速度？","你想先照顧哪個部分的你？"]},
  {id:16, cat:"cocktail",emoji:"🥃", name:"威士忌酸（Whiskey Sour）", tag:"酸甜平衡・柔和轉折", moods:["放鬆"],
    story:"像一句道歉：不卑微、不逞強，只是把關係拉回剛剛好。",
    flavor:"檸檬酸＋威士忌，甜度平衡。",
    warn:"酸度＋酒精都在，慢慢喝。",
    followUps:["你想修補的是關係，還是你自己？","你願意給自己一個轉折嗎？"]},
  {id:17, cat:"cocktail",emoji:"🍯", name:"熱托迪（Hot Toddy）", tag:"暖暖的・像被抱一下", moods:["放鬆"],
    story:"這杯像把你捧在手心，慢慢暖回來。",
    flavor:"蜂蜜＋檸檬＋溫熱酒香。",
    warn:"熱飲也別喝快；身體不適就停。",
    followUps:["你想被怎麼安慰？","你願意先讓自己暖一點嗎？"]},
  {id:18, cat:"na",      emoji:"🫧", name:"無酒精調酒（Mocktail）", tag:"不喝也很酷・享受氛圍", moods:["放鬆"],
    story:"你不需要酒精才能放鬆。你值得的是被好好對待的夜晚。",
    flavor:"果香/草本/氣泡都可能（依配方），清爽感高。",
    warn:"仍可能含糖較高；注意攝取。",
    followUps:["今晚不喝也沒關係，你想怎麼溫柔自己？","如果只選一個舒服的小事，你選什麼？"]},
  {id:19, cat:"na",      emoji:"🍵", name:"蜂蜜檸檬氣泡", tag:"清爽又柔軟・像微笑", moods:["放鬆"],
    story:"不是要你忘記難過，只是讓你先好呼吸。",
    flavor:"檸檬清香＋蜂蜜柔甜＋氣泡。",
    warn:"含糖飲也別喝太急。",
    followUps:["你現在最需要的是什麼？","你願意先照顧自己一下嗎？"]},
  {id:20, cat:"na",      emoji:"🌿", name:"草本氣泡（無酒精）", tag:"清醒放鬆・把腦袋放空", moods:["放鬆"],
    story:"清醒也能放鬆，今晚我們只求舒服。",
    flavor:"草本清香＋氣泡清爽。",
    warn:"若胃敏感，先小口試。",
    followUps:["你想把哪句雜音關小聲？","你願意先休息再決定嗎？"]},

  // ===================== 🗣️ 聊聊 20 杯 =====================
  {id:21, cat:"beer",    emoji:"🍺", name:"艾爾（Ale）", tag:"麥香溫暖・耐聊", moods:["聊聊"],
    story:"艾爾像會陪你聊的朋友：溫暖、有香氣，讓心事變好說。",
    flavor:"厚一點的麥芽香，常帶果香或焦糖感。",
    warn:"酒感較明顯，別急著喝快。",
    followUps:["你希望今晚的聊天偏溫柔還是直接？","最想被理解的是哪一件事？"]},
  {id:22, cat:"beer",    emoji:"🍺", name:"IPA", tag:"苦香醒腦・反差回甘", moods:["聊聊"],
    story:"先苦後回甘像成長：承認累，才會回甜。",
    flavor:"柑橘/松針啤酒花香，苦韻明顯。",
    warn:"初學者少量；苦味可能讓你喝更快，記得慢。",
    followUps:["你覺得苦的是事情，還是期待？","回甘那刻你想對自己說什麼？"]},
  {id:23, cat:"beer",    emoji:"🍺", name:"波特（Porter）", tag:"深色麥香・夜晚聊天", moods:["聊聊"],
    story:"這杯像夜裡的低音，適合把真心慢慢說。",
    flavor:"焦糖/可可麥香，柔厚。",
    warn:"偏濃，小口慢喝。",
    followUps:["你最想說出口但一直忍著的是什麼？","今晚你想被怎麼理解？"]},
  {id:24, cat:"beer",    emoji:"🍺", name:"比利時修道院（Dubbel）", tag:"焦糖果乾・成熟耐聊", moods:["聊聊"],
    story:"像一段很長的故事：甜、苦、暖，都有。",
    flavor:"焦糖、果乾香，酒感明顯。",
    warn:"度數較高，慢慢喝。",
    followUps:["你願意把故事說到哪裡就好？","你想先被安慰還是被理解？"]},
  {id:25, cat:"red",     emoji:"🍷", name:"卡本內蘇維濃", tag:"成熟有力・結構感紅酒", moods:["聊聊"],
    story:"像一位有肩膀的大人：你可以靠一下，然後想起你其實也很強。",
    flavor:"黑醋栗＋木質感，單寧較明顯。",
    warn:"酒感較強，搭配食物更舒服。",
    followUps:["你最近最撐的是哪件事？","你願意把責任放下一點點嗎？"]},
  {id:26, cat:"red",     emoji:"🍷", name:"黑皮諾（Pinot Noir）", tag:"細緻・像把話說溫柔", moods:["聊聊"],
    story:"不用大聲，你的感受也值得被聽見。",
    flavor:"紅莓、花香，口感細緻。",
    warn:"搭配清淡餐點更舒服。",
    followUps:["你最想被怎麼回應？","你想先說哪一句？"]},
  {id:27, cat:"red",     emoji:"🍷", name:"希哈（Syrah / Shiraz）", tag:"辛香厚實・把心事說清楚", moods:["聊聊"],
    story:"像把模糊的心事，慢慢說成一句懂得的話。",
    flavor:"黑莓、胡椒辛香，厚實。",
    warn:"酒感偏重，慢喝。",
    followUps:["你想把混亂整理成哪三個字？","你想把哪句話說清楚？"]},
  {id:28, cat:"spirit",  emoji:"🥃", name:"威士忌（Whisky）", tag:"深沉木質・慢慢聊", moods:["聊聊"],
    story:"像深夜對話：不急著結論，只陪你把真心說完。",
    flavor:"木質＋香草＋焦糖（依桶陳）。",
    warn:"酒精濃度高，小口即可。",
    followUps:["你最想說的真心是哪句？","你想要陪伴還是方向？"]},
  {id:29, cat:"spirit",  emoji:"🥃", name:"蘇格蘭（Scotch）", tag:"煙燻泥煤・回憶感", moods:["聊聊"],
    story:"煙燻像回憶：有些刺、有些暖，入口後更懂自己。",
    flavor:"煙燻/泥煤，可能帶海風鹹感（依產區）。",
    warn:"初次可加一點水；不要急喝。",
    followUps:["那段回憶你想留著還是放下？","你願意原諒當時的自己嗎？"]},
  {id:30, cat:"spirit",  emoji:"🥃", name:"干邑（Cognac）", tag:"果乾木質・慢慢說真心", moods:["聊聊"],
    story:"像一位懂你的大人：不評價，只提醒你其實很珍貴。",
    flavor:"果乾、橡木、溫暖酒香。",
    warn:"度數高，小口。",
    followUps:["你想被理解的核心是什麼？","你其實很努力，你知道嗎？"]},
  {id:31, cat:"spirit",  emoji:"🍸", name:"琴酒（Gin）", tag:"草本清醒・俐落微醺", moods:["聊聊"],
    story:"像把腦袋整理好：清爽俐落，但仍有香氣的情緒。",
    flavor:"杜松子＋草本＋柑橘皮香。",
    warn:"搭配含糖飲很容易喝快，記得慢。",
    followUps:["你想把混亂整理成哪三個字？","你願意先把自己放回中心嗎？"]},
  {id:32, cat:"spirit",  emoji:"🌿", name:"苦艾系利口酒（Amaro）", tag:"苦甜平衡・把感受說清楚", moods:["聊聊"],
    story:"苦不是壞，是你在乎。把在乎說出來就不那麼重。",
    flavor:"草本苦甜，尾韻長。",
    warn:"苦感明顯，先小口。",
    followUps:["你願意把『苦』說出口嗎？","你在乎的是什麼？"]},
  {id:33, cat:"cocktail",emoji:"🍸", name:"尼格羅尼（Negroni）", tag:"苦甜成熟・反差回甘", moods:["聊聊"],
    story:"先苦後回甘：不是每次都舒服，但會更懂自己。",
    flavor:"苦甜草本＋柑橘皮香，尾韻長。",
    warn:"苦感明顯，初學者少量。",
    followUps:["你最近在練習的成熟是什麼？","你願意把『苦』說出口嗎？"]},
  {id:34, cat:"cocktail",emoji:"🥃", name:"老古典（Old Fashioned）", tag:"經典穩重・慢甜", moods:["聊聊"],
    story:"不追流行，只把基本做好。像你：其實很可靠。",
    flavor:"威士忌＋糖＋苦精＋橙皮香。",
    warn:"濃度高，小口就很夠。",
    followUps:["你最可靠的一面是什麼？","你願意承認你也需要被照顧嗎？"]},
  {id:35, cat:"cocktail",emoji:"🥃", name:"曼哈頓（Manhattan）", tag:"成熟俐落・把話說準", moods:["聊聊"],
    story:"像一句短句：不多，但很準。",
    flavor:"威士忌＋甜苦平衡，尾韻長。",
    warn:"濃度偏高，小口。",
    followUps:["你今天最想停止解釋的是什麼？","你想把界線放在哪？"]},
  {id:36, cat:"cocktail",emoji:"🍸", name:"馬丁尼（Martini）", tag:"極簡乾淨・高冷優雅", moods:["聊聊"],
    story:"像一句短句：不多，但很準。今晚不解釋也可以。",
    flavor:"乾淨草本，可能帶橄欖鹹香。",
    warn:"濃度高，慢慢喝。",
    followUps:["你今天最想停止解釋的是什麼？","你願意回到自己的中心嗎？"]},
  {id:37, cat:"cocktail",emoji:"🥃", name:"布魯瓦迪耶（Boulevardier）", tag:"苦甜厚實・成熟聊天", moods:["聊聊"],
    story:"有一點苦，代表你走過一些事。",
    flavor:"威士忌＋苦甜草本。",
    warn:"酒感厚，小口。",
    followUps:["你最想被理解的是哪段路？","你願意肯定自己一次嗎？"]},
  {id:38, cat:"cocktail",emoji:"🍅", name:"血腥瑪麗（Bloody Mary）", tag:"香料番茄・醒腦湯感", moods:["聊聊"],
    story:"像一碗勇敢的湯：有點辣、有點鹹，喝完會覺得我還可以。",
    flavor:"番茄＋香料＋胡椒（依配方）。",
    warn:"含鹽香料；血壓/腎臟需留意者慎飲。",
    followUps:["你願意為自己打氣一句嗎？","你的『還可以』來自哪裡？"]},
  {id:39, cat:"spirit",  emoji:"🍑", name:"梅酒", tag:"酸甜果香・心比較好開口", moods:["聊聊"],
    story:"像一句撒嬌：甜甜帶酸，讓心變得好打開。",
    flavor:"梅子果香＋酸甜平衡，柔順。",
    warn:"甜口很容易喝多；慢慢喝。",
    followUps:["你今天想要的甜是哪一種？","你最近的小確幸是什麼？"]},
  {id:40, cat:"cocktail",emoji:"☕️", name:"濃縮咖啡馬丁尼（Espresso Martini）", tag:"微苦提神・適合深聊", moods:["聊聊"],
    story:"有些話要在清醒一點的時候才說得出來。",
    flavor:"咖啡香＋甜苦平衡。",
    warn:"含咖啡因；別太晚喝太多。",
    followUps:["你想把哪句話說出口？","你其實在意的是什麼？"]},

  // ===================== 🎉 慶祝 20 杯 =====================
  {id:41, cat:"white",   emoji:"🥂", name:"氣泡酒（Sparkling）", tag:"泡泡儀式感・把日子變亮", moods:["慶祝"],
    story:"每個泡泡都在說：你值得開心。小快樂也值得乾杯。",
    flavor:"清脆氣泡＋果香，收口俐落。",
    warn:"氣泡會加速吸收，慢慢喝。",
    followUps:["你想為哪件小事乾杯？","今天最亮的瞬間是？"]},
  {id:42, cat:"white",   emoji:"🍷", name:"粉紅酒（Rosé）", tag:"輕盈可愛・剛剛好", moods:["慶祝"],
    story:"像一句剛剛好的稱讚：不過度、不敷衍，很剛好。",
    flavor:"莓果＋花香，輕盈順口（依風格）。",
    warn:"甜口更容易不知不覺喝多。",
    followUps:["你想把今晚變可愛一點嗎？","你最近的小幸福是什麼？"]},
  {id:43, cat:"spirit",  emoji:"🍸", name:"伏特加（Vodka）", tag:"乾淨中性・今晚你說了算", moods:["慶祝"],
    story:"像白紙：你怎麼搭，它就怎麼陪你。你可以決定今晚味道。",
    flavor:"乾淨、酒感直接、香氣少。",
    warn:"順口不代表弱，請慢慢喝。",
    followUps:["你想把今晚調成什麼味道？","你最想自己決定的是什麼？"]},
  {id:44, cat:"spirit",  emoji:"🥃", name:"龍舌蘭（Tequila）", tag:"陽光冒險・直球熱烈", moods:["慶祝"],
    story:"像沙漠太陽：直接、熱烈。喝的不是刺激，是勇敢。",
    flavor:"植物香＋胡椒感，收口乾爽。",
    warn:"別連續 shot；慢喝最安全。",
    followUps:["你願意勇敢一次會選哪件事？","你想把熱情放回哪裡？"]},
  {id:45, cat:"spirit",  emoji:"🥃", name:"高粱酒", tag:"直球辛香・存在感強", moods:["慶祝"],
    story:"像一句真話：不拐彎抹角。但真話也要溫柔地說。",
    flavor:"辛香＋穀物香，酒感直接。",
    warn:"濃度高！小口即可，避免連續杯。",
    followUps:["你最想說的真話是什麼？","你想把哪個糾結斷開？"]},
  {id:46, cat:"na",      emoji:"🥂", name:"低酒精氣泡調飲", tag:"輕盈不負擔・剛剛好", moods:["慶祝"],
    story:"像把疲憊調得更輕：不硬撐，也不放縱。剛剛好最美。",
    flavor:"輕果香＋細緻氣泡，甜度柔和。",
    warn:"仍含酒精；未滿 18 禁止飲用。",
    followUps:["你想把今天變輕的第一步是什麼？","你想要的快樂是安靜還是熱鬧？"]},
  {id:47, cat:"cocktail",emoji:"🍸", name:"莫希托（Mojito）", tag:"薄荷清爽・透氣自由", moods:["慶祝"],
    story:"像把心裡的悶打開一條縫：讓你呼吸到自由。",
    flavor:"薄荷＋萊姆清酸＋氣泡清爽。",
    warn:"清爽很容易喝多，慢慢喝。",
    followUps:["你想吐掉的那口悶氣是什麼？","你願意先讓自己喘口氣嗎？"]},
  {id:48, cat:"cocktail",emoji:"🍸", name:"瑪格麗特（Margarita）", tag:"酸甜鹽邊・有態度", moods:["慶祝"],
    story:"鹽邊像界線：你可以溫柔，但不必委屈自己。",
    flavor:"萊姆酸＋龍舌蘭，鹽邊提味。",
    warn:"酸度高；胃敏感者搭食物。",
    followUps:["你最想對哪件事說『不』？","你想守護的界線是什麼？"]},
  {id:49, cat:"cocktail",emoji:"🍸", name:"琴通寧（Gin Tonic）", tag:"清爽草本・簡單耐喝", moods:["慶祝"],
    story:"像把今天清掉：你不必贏，只要把自己照顧好。",
    flavor:"杜松草本＋通寧微苦＋氣泡。",
    warn:"氣泡加速吸收；慢喝。",
    followUps:["你想把今天清掉的第一件事是？","你需要放鬆還是肯定？"]},
  {id:50, cat:"cocktail",emoji:"🍹", name:"長島冰茶（Long Island Iced Tea）", tag:"看似溫柔其實很猛", moods:["慶祝"],
    story:"像『看起來沒事』的你：表面輕鬆，裡面其實撐很久。",
    flavor:"多基酒混合＋柑橘與可樂感，酒感隱藏。",
    warn:"濃度高！務必慢喝；喝酒不開車。",
    followUps:["你有哪件事其實撐很久？","你願意讓自己不用假裝嗎？"]},
  {id:51, cat:"cocktail",emoji:"🍹", name:"帕洛瑪（Paloma）", tag:"柚香清爽・很適合乾杯", moods:["慶祝"],
    story:"像一個輕快的轉身：你可以開心，不用理由太多。",
    flavor:"柚子/葡萄柚＋氣泡清爽。",
    warn:"清爽容易喝快，放慢節奏。",
    followUps:["你想把今晚變成什麼顏色？","你願意為自己開心一次嗎？"]},
  {id:52, cat:"cocktail",emoji:"🍊", name:"阿佩羅橙光（Aperol Spritz）", tag:"橙橙亮亮・儀式感", moods:["慶祝"],
    story:"像夕陽一樣亮：把普通的一天變成值得紀念。",
    flavor:"柑橘微苦＋氣泡。",
    warn:"氣泡會加速吸收，慢慢喝。",
    followUps:["你想為哪件小事慶祝？","今天最值得記住的是什麼？"]},
  {id:53, cat:"cocktail",emoji:"🍊", name:"含羞草（Mimosa）", tag:"早午餐乾杯・可愛又輕快", moods:["慶祝"],
    story:"不用等到很大成功，現在就可以為你乾杯。",
    flavor:"橙汁＋氣泡酒，清爽果香。",
    warn:"甜口容易喝多。",
    followUps:["你最近做對的一件事是什麼？","你想聽到別人怎麼稱讚你？"]},
  {id:54, cat:"cocktail",emoji:"🍷", name:"桑格利亞（Sangria）", tag:"果香派對・分享型快樂", moods:["慶祝"],
    story:"像把快樂切成小片分給大家：你也值得分到那一份。",
    flavor:"水果浸泡香氣，甜酸平衡。",
    warn:"甜口＋酒精容易超量，記得慢。",
    followUps:["你想跟誰一起乾杯？","你想把快樂分享給誰？"]},
  {id:55, cat:"cocktail",emoji:"🍹", name:"莫斯科驢子（Moscow Mule）", tag:"薑香氣泡・爽快", moods:["慶祝"],
    story:"像一句『走吧！』把你從疲憊拉回生活。",
    flavor:"薑汁＋萊姆＋氣泡。",
    warn:"氣泡加速吸收；慢喝。",
    followUps:["你想把今晚過得更爽快一點嗎？","你想要熱鬧還是自在？"]},
  {id:56, cat:"cocktail",emoji:"🥥", name:"椰林飄香（Piña Colada）", tag:"度假感・放鬆式慶祝", moods:["慶祝"],
    story:"把心丟到海邊一下也可以。",
    flavor:"椰奶＋鳳梨甜香。",
    warn:"甜口很容易喝多。",
    followUps:["你想把自己帶去什麼地方？","你願意放鬆地開心一次嗎？"]},
  {id:57, cat:"cocktail",emoji:"🍋", name:"代基里（Daiquiri）", tag:"酸甜俐落・乾杯很順", moods:["慶祝"],
    story:"俐落乾杯，俐落快樂。",
    flavor:"萊姆酸甜，乾淨酒感。",
    warn:"酸度高，胃敏感者搭食物。",
    followUps:["你想用一句話為今晚命名？","你願意把自己放在第一位嗎？"]},
  {id:58, cat:"cocktail",emoji:"🥂", name:"法式 75（French 75）", tag:"優雅氣泡・像煙火", moods:["慶祝"],
    story:"像小煙火：你值得被看見一次。",
    flavor:"琴酒＋檸檬＋氣泡酒，清爽。",
    warn:"氣泡加速吸收，慢喝。",
    followUps:["你想為哪個你乾杯？","你最想被誰稱讚？"]},
  {id:59, cat:"cocktail",emoji:"🥃", name:"Highball（威士忌蘇打）", tag:"清爽俐落・越喝越開心", moods:["慶祝"],
    story:"像把心情打亮：清爽乾杯、清爽前進。",
    flavor:"威士忌＋蘇打氣泡。",
    warn:"看似清爽也別喝快。",
    followUps:["你想把今天變亮的原因是什麼？","你願意稱讚自己一次嗎？"]},
  {id:60, cat:"na",      emoji:"🍓", name:"派對莓果氣泡（無酒精）", tag:"不喝也能超嗨", moods:["慶祝"],
    story:"你不喝也可以很快樂，開心不是酒精才給的。",
    flavor:"莓果果香＋氣泡。",
    warn:"含糖飲也要適量。",
    followUps:["你想怎麼慶祝自己？","你願意把今晚過得可愛一點嗎？"]}
];
...
function partyBearSpeak(){
  ...
  if(mood === "聊聊") lines.push(...PARTY_BEAR_LINES.chat);
  if(mood === "慶祝") lines.push(...PARTY_BEAR_LINES.celebrate);
...
function decideRandomMode(){
  const mood = currentMood || null;
  let pTruth = 0.5;
  if(mood === "聊聊") pTruth = 0.7;
  if(mood === "慶祝") pTruth = 0.3;
